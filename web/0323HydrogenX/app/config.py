...
EMBEDDED_OPENCLAW_GATEWAY_TOKEN = "将GATEWAY_TOKEN复制到这里！！！"
...
class Config:
    ...
    OPENCLAW_UPLOADS_DIR = os.getenv("OPENCLAW_UPLOADS_DIR", "instance/uploads")
    OPENCLAW_MAX_UPLOAD_MB = int(os.getenv("OPENCLAW_MAX_UPLOAD_MB", "20"))
